            ...
            <div class="wpb_wrapper">
                <div class="row facts white">
                    <div class="container invo_auto_width">
                        <div class="col-sm-6">
                            <div>
                                <input type="text" data-validation="required" class="form-control valid" value=""
                                    placeholder="Name*" name="name" style="">
                            </div>
                            <div><input type="text" data-validation="number" class="form-control" value=""
                                    placeholder="Phone No*" name="phono"></div>
                            <div><input type="text" data-validation="email" class="form-control" value=""
                                    placeholder="E-mail*" name="email"></div>
                            <div><input type="text" data-validation="required" class="form-control" value=""
                                    placeholder="Subject*" name="subject"></div>
                        </div>
                        <div class="col-sm-6">
                            <textarea name="Message" class="form-control" id="Message" data-validation="required"
